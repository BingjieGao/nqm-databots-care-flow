module.exports = (function() {
   ...
   * case "serviceRatio"
   */
  const behaviourFactory = function(areaServiceId, areaServiceDataset, tdxApi) {
    let databot;
    return tdxApi.getDatasetDataAsync(areaServiceDataset, {areaServiceId: areaServiceId},
      null, null)
      .then((result) => {
